...
new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/voxelwise_so_ampm_corr_rmap_xaxisso.nii';
spm_write_vol(new_info_os_r, reshaped_3d_r);
new_info_os_p=info_os;
new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/voxelwise_so_ampm_corr_pmap_xaxisso.nii';
...
fdr_pos_new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_ampm_corr_rmap_wholebrain_noCBS_xaxisso.nii';
spm_write_vol(fdr_pos_new_info_os_r,fdr_pos_voxel_r);
fdr_pos_new_info_os_p=info_os;
fdr_pos_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_ampm_corr_pmap_wholebrain_noCBS_xaxisso.nii';
spm_write_vol(fdr_pos_new_info_os_p, 1-fdr_pos_voxel_p);

fdr_neg_new_info_os_r=info_os;
fdr_neg_new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_ampm_corr_rmap_wholebrain_noCBS_xaxisso.nii';
spm_write_vol(fdr_neg_new_info_os_r,fdr_neg_voxel_r);
fdr_neg_new_info_os_p=info_os;
fdr_neg_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_ampm_corr_pmap_wholebrain_noCBS_xaxisso.nii';
