...
ampm_dir = '/mnt/tambinidata/sleepstudy/data/derivatives/group/ospan_vs_math/allsessions/allsub/';
...
data_fl = [ampm_dir 'positive/group_allsessions_ospan_vs_math_allsub_pos.nii'];
