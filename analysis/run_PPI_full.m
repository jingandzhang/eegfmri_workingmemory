...
voi_list={'L_Stri','R_Stri'}%{'Post_R_Hipp','Post_L_Hipp','L_Caud','R_Caud','L_Puta','R_Puta','L_Stri','R_Stri','R_Hipp','L_Hipp','R_Accu','L_Accu','R_Pall','L_Pall','R_Lc','L_Lc','R_Thal','L_Thal'};

for iss=15%:length(ss_list)
    ss = ss_list{iss};
    ...
    for i_ses= 1:length(sessions)
        ...
        for i=1:length(voi_list)
            voi_name = voi_list{i};
            mkdir([ppi_dir voi_name]);
            spm_mat_file=[ppi_dir 'SPM.mat'];
            copyfile(spm_mat_file, [ppi_dir '/' voi_name])
            unix(['mv ' [ppi_dir '/' voi_name '/SPM.mat'] ' ' [ppi_dir '/' voi_name '/SPM.mat']]);
            matlabbatch{1}.spm.stats.ppi.spmmat = {[ppi_dir '/' voi_name '/SPM_model1.mat']};
            matlabbatch{1}.spm.stats.ppi.type.ppi.voi = {[ppi_dir '/VOI_' voi_name '_1.mat']};
            ...
            %%%%%%%%%%%%%%%%
            load ([ppi_dir '/' voi_name '/' 'PPI_' voi_name '.mat'])%load PPI mat for that voi
            matlabbatch{1}.spm.stats.fmri_spec.dir = {[ppi_dir '/' voi_name]};
            ...
            matlabbatch{2}.spm.stats.fmri_est.spmmat = {[ppi_dir '/' voi_name '/SPM.mat']};%cfg_dep('fMRI model specification: SPM.mat File', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
            matlabbatch{2}.spm.stats.fmri_est.write_residuals = 0;
            matlabbatch{2}.spm.stats.fmri_est.method.Classical = 1;
            
            matlabbatch{3}.spm.stats.con.spmmat = {[ppi_dir '/' voi_name '/SPM.mat']}; %cfg_dep('Model estimation: SPM.mat File', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
            matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = [voi_name '_PPI_Interaction'];
