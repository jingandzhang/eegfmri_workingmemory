...
Nsub = 38;
T_crit = -tinv(.05, Nsub); %0.05


roi_dir = '/mnt/tambinidata/atlas/Yeo_JNeurophysiol11_MNI152/200parcels/';
Nrois = 200;
...
save('voxel_num_p05_200parcel.mat','tvalue_avg','Mean', 'Prop','roi_list');
%%
Nrois_sig=48
...
for i=1:Nrois_sig
   data_roi=Prop(:,:,i);
   [H,P,ci,stat]=ttest(data_roi(:,1:2:3),data_roi(:,2:2:4))
