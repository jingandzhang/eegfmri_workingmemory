...
%mask_fl = '/home/jing/Documents/negative/Neg_cluster_maskall_mask.nii';
%mask_fl = '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/cluster_index_allsession_noCBS_tfcemask.nii';
...
new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/voxelwise_so_ampm_retvsbase_corr_rmap_noCBSmask.nii';
spm_write_vol(new_info_os_r, reshaped_3d_r);
new_info_os_p=info_os;
new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/voxelwise_so_ampm_retvsbase_corr_pmap_noCBSmask.nii';
...
fdr_pos_new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/fdr_pos_voxelwise_so_ampm_retvsbase_corr_rmap_noCBS_mask.nii';
spm_write_vol(fdr_pos_new_info_os_r,fdr_pos_voxel_r);
fdr_pos_new_info_os_p=info_os;
fdr_pos_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/fdr_pos_voxelwise_so_ampm_retvsbase_corr_pmap_noCBS_mask.nii';
spm_write_vol(fdr_pos_new_info_os_p, 1-fdr_pos_voxel_p);

fdr_neg_new_info_os_r=info_os;
fdr_neg_new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/fdr_neg_voxelwise_so_ampm_retvsbase_corr_rmap_noCBS_mask.nii';
spm_write_vol(fdr_neg_new_info_os_r,fdr_neg_voxel_r);
fdr_neg_new_info_os_p=info_os;
fdr_neg_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/ret_vs_baseline/fdr_neg_voxelwise_so_ampm_retvsbase_corr_pmap_noCBS_mask.nii';
