...
for ii=1:size(reshaped_os_data,2)
    ...
    [b, stats] = robustfit(reshaped_math_data(:,ii) ,reshaped_so_data(:,ii));
    
    voxel_p_math(ii)=round(stats.p(2),5);   
    voxel_t_math(ii)=round(stats.t(2),5);
...
% new_info_os_t.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/voxelwise_so_os_1factor_corr_tmap_multiregression.nii';
% spm_write_vol(new_info_os_t, reshaped_3d_t_ospan);
% new_info_os_p=info_os;
% new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/voxelwise_so_os_1factor_corr_pmap_multiregression.nii';
...
new_info_math_t.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/voxelwise_so_math_1factor_corr_tmap_multiregression.nii';
spm_write_vol(new_info_math_t, reshaped_3d_t_math);
new_info_math_p=info_math;
new_info_math_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/voxelwise_so_math_1factor_corr_pmap_multiregression.nii';
...
% fdr_pos_new_info_os_t.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_os_1factor_ampm_corr_tmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_pos_new_info_os_t,fdr_pos_voxel_r);
% fdr_pos_new_info_os_p=info_os;
% fdr_pos_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_os_1factor_ampm_corr_pmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_pos_new_info_os_p, 1-fdr_pos_voxel_p);
% 
% fdr_neg_new_info_os_r=info_os;
% fdr_neg_new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_os_1factor_ampm_corr_tmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_neg_new_info_os_r,fdr_neg_voxel_r);
% fdr_neg_new_info_os_p=info_os;
% fdr_neg_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_os_1factor_ampm_corr_pmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_neg_new_info_os_p, 1-fdr_neg_voxel_p);
% 
%write data
% fdr_pos_new_info_ret_t=info_ospan;
% fdr_pos_new_info_ret_t.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_ret_1factor_ampm_corr_tmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_pos_new_info_ret_t,fdr_pos_voxel_r_ret);
% fdr_pos_new_info_ret_p=info_ospan;
% fdr_pos_new_info_ret_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_ret_1factor_ampm_corr_pmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_pos_new_info_ret_p, 1-fdr_pos_voxel_p_ret);
% 
% fdr_neg_new_info_os_r=info_os;
% fdr_neg_new_info_os_r.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_ret_1factor_ampm_corr_tmap_noCBS_multipleregression.nii';
% spm_write_vol(fdr_neg_new_info_os_r,fdr_neg_voxel_r_ret);
% fdr_neg_new_info_os_p=info_os;
% fdr_neg_new_info_os_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_ret_1factor_ampm_corr_pmap_noCBS_multipleregression.nii';
...
fdr_pos_new_info_math_t.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_math_1factor_ampm_corr_tmap_noCBS_multipleregression.nii';
spm_write_vol(fdr_pos_new_info_math_t,fdr_pos_voxel_t_math);
fdr_pos_new_info_math_p=info_math;
fdr_pos_new_info_math_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_pos_voxelwise_so_math_1factor_ampm_corr_pmap_noCBS_multipleregression.nii';
spm_write_vol(fdr_pos_new_info_math_p, 1-fdr_pos_voxel_p_math);

fdr_neg_new_info_math_t=info_math;
fdr_neg_new_info_math_t.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_math_1factor_ampm_corr_tmap_noCBS_multipleregression.nii';
spm_write_vol(fdr_neg_new_info_math_t,fdr_neg_voxel_t_math);
fdr_neg_new_info_math_p=info_math;
fdr_neg_new_info_math_p.fname= '/mnt/tambinidata/sleepstudy/data/derivatives/group/so_vs_ampm_corr/fdr_neg_voxelwise_so_math_1factor_ampm_corr_pmap_noCBS_multipleregression.nii';
